---
name: parallel-task-api-juridique-fr
description: Deuxieme couche Parallel Task API pour workflows juridiques FR batchables, schemas et run_id.
---
...
Deuxieme couche Parallel Task API pour workflows juridiques FR batchables, schemas et run_id.
