---
description: Creer un playbook a partir d'un brief ou document de reference.
argument-hint: "[entree] [options]"
allowed-tools: Read, Write, Glob, Task
---

# conformite:creer-playbook

## Cabinet-grade workflow

Workflow cible: `revue-conformite-interne`.
...
- `plugins/vertical-plugins/legal-fr/schemas/workflows/revue-conformite-interne/extraction.schema.json`
- `plugins/vertical-plugins/legal-fr/schemas/workflows/revue-conformite-interne/report.schema.json`
