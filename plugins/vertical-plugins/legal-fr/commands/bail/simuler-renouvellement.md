---
description: Simuler revision, renouvellement et echeances.
argument-hint: "[entree] [options]"
allowed-tools: Read, Write, Glob, Task
---

# bail:simuler-renouvellement

## Cabinet-grade workflow

Workflow cible: `red-flags-bail`.
...
- `plugins/vertical-plugins/legal-fr/schemas/workflows/red-flags-bail/extraction.schema.json`
- `plugins/vertical-plugins/legal-fr/schemas/workflows/red-flags-bail/report.schema.json`
