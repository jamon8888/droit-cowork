---
description: Verifier les sources juridiques et societaires disponibles.
argument-hint: "[entree] [options]"
allowed-tools: Read, Write, Glob, Task
---

# tdd:verifier-sources

## Cabinet-grade workflow

Workflow cible: `tabular-due-diligence`.
...
- `plugins/vertical-plugins/legal-fr/schemas/workflows/tabular-due-diligence/extraction.schema.json`
- `plugins/vertical-plugins/legal-fr/schemas/workflows/tabular-due-diligence/report.schema.json`
