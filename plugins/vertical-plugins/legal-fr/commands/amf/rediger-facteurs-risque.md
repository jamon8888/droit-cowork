---
description: Rediger une section facteurs de risque AMF.
argument-hint: "[entree] [options]"
allowed-tools: Read, Write, Glob, Task
---

# amf:rediger-facteurs-risque

## Cabinet-grade workflow

Workflow cible: `note-information-amf`.
...
- `plugins/vertical-plugins/legal-fr/schemas/workflows/note-information-amf/extraction.schema.json`
- `plugins/vertical-plugins/legal-fr/schemas/workflows/note-information-amf/report.schema.json`
