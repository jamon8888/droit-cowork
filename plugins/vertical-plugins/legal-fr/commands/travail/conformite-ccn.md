---
description: Verifier la conformite a une convention collective.
argument-hint: "[entree] [options]"
allowed-tools: Read, Write, Glob, Task
---

# travail:conformite-ccn

## Cabinet-grade workflow

Workflow cible: `revue-contrats-travail`.
...
- `plugins/vertical-plugins/legal-fr/schemas/workflows/revue-contrats-travail/extraction.schema.json`
- `plugins/vertical-plugins/legal-fr/schemas/workflows/revue-contrats-travail/report.schema.json`
