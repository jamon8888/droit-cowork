---
name: recherche:task-run
description: Lancer une recherche juridique FR via la couche Parallel Task API.
...
Outil principal: `python scripts/legal_fr_parallel_task.py`.
