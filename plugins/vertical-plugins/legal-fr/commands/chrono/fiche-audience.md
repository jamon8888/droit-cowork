---
description: Produire une fiche d'audience depuis la chronologie.
argument-hint: "[entree] [options]"
allowed-tools: Read, Write, Glob, Task
---

# chrono:fiche-audience

## Cabinet-grade workflow

Workflow cible: `chronologie-contentieux`.
...
- `plugins/vertical-plugins/legal-fr/schemas/workflows/chronologie-contentieux/extraction.schema.json`
- `plugins/vertical-plugins/legal-fr/schemas/workflows/chronologie-contentieux/report.schema.json`
